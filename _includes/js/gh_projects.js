    ...
    $(repos).each(function () {
      ...
      if ((this.name != (username.toLowerCase() + '.github.com')) && (checkfork != true)) { /* Check for username.github.com repo and for forked projects */
        list.append('<dt> \
                        ...
                        <div style="padding-top: 2%;"><p>' + (this.description ? this.description : '<i style="color:#999">No description</i>') + (this.homepage ? ('<a href="' + this.homepage + '"> ' + this.homepage + '</a>') : "") + '</p></div> \
                    ');
